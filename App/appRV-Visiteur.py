...
@app.route( '/rapports/<matricule>/<dateVisite>/<bilan>/<coefConfiance>/<dateSaisie>/<rap_motif>/<praticien>' , methods = [ 'POST' ] )
def addRapportVisite(matricule, dateVisite, bilan, coefConfiance, dateSaisie, rap_motif, praticien) :


	# unRapport = json.loads( request.data )

	numRapport = modeleGSBRV.enregistrerRapportVisite( 	matricule ,
																dateVisite,
																bilan,
																coefConfiance,
																dateSaisie,
...
if __name__ == '__main__' :
	app.run( debug = True , host = '192.168.1.30' , port = 5000 )