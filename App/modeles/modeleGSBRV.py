...
def enregistrerRapportVisite( matricule, dateVisite, bilan, coefConfiance, dateSaisie, rap_motif, numPraticien ) :
	...
	if numRapportVisite != None :
		...
		try:
			...
			curseur.execute( requete, ( matricule , numRapportVisite , dateVisite, bilan ,coefConfiance, dateSaisie, rap_motif, numPraticien ) )
			connexionBD.commit()
			curseur.close()
